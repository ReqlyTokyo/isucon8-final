...
def info():
    ...
    res["chart_by_sec"] = model.get_candlestic_data(db, from_t, window="sec")
    ...
    res["chart_by_hour"] = model.get_candlestic_data(db, from_t, window="hour")
